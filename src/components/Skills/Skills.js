    ...
    return (
        <Container className='my-3 px-6' style={{ backgroundColor: 'white' }}>
            ...
            <ul>
                ...
                <li><strong>Others:</strong> Git, Github , Bitbucket , Netlify, Heroku , Adobe Photoshop , Adobe illustrator , InDesign , Sketchup , Microsoft Office , Google Ad Manager , Rackspace.</li>
                <br />
            </ul>
